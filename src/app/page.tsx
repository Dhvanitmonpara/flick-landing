    ...
    <div className="min-h-screen bg-gradient-to-tr from-sky-50/70 via-sky-100/90 dark:from-sky-900/30 dark:via-sky-950/50 to-background">
      ...
      <div className="max-w-6xl mx-auto px-8 lg:px-4">
        <div className="flex justify-center items-center">
          <div className="flex flex-col justify-center items-start gap-6 sm:gap-8 pb-8">
            <AnimateWrapper delay={0.3} once>
              <SecondaryButton />
            </AnimateWrapper>
            <div className="flex flex-col justify-center text-neutral-700 dark:text-neutral-300">
              <TextAnimate as="h1" delay={0.4} className="font-neue-montreal text-start text-3xl sm:text-4xl md:text-5xl lg:text-6xl" animation="blurInUp" by="word" once>
                Your Anonymous Campus Hangout
              </TextAnimate>
              <TextAnimate delay={0.6} className="font-inter text-start mt-4 sm:mt-6 sm:text-lg md:text-xl lg:text-2xl" animation="blurInUp" by="word" once>
          ...
          <div className="space-y-4 ml-12 w-[700px]">
            <img src="tweet.png" alt="" />
            <img src="tweet.png" alt="" />
            <img src="tweet.png" alt="" />
          </div>
        </div>
        <div className="grid gap-4 mt-12 sm:grid-cols-2 md:grid-cols-2 text-center">
