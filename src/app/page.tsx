...
export default function Home() {
  return (
    <div className="min-h-screen gap-8 px-4 max-w-5xl mx-auto">
      <Header />
      ...
      <div className="min-h-96 rounded-2xl overflow-hidden shadow-[0_-4px_28px_rgba(0,0,0,0.25)] border-[0.5px]">
